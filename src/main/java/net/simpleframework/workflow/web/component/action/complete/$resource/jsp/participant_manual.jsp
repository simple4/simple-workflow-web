...
<%
	final ComponentParameter nComponentParameter = WorkitemCompleteUtils
	...
	final IPagePermissionHandler participantMgr = (IPagePermissionHandler) WorkflowContextFactory
			.get().getParticipantMgr();
%>
<div class="simple_window_tcb participant_manual">
  <%
  	for (final TransitionNode transition : WorkitemCompleteUtils.getTransitions(
  			nComponentParameter, workitem)) {
  %>
  ...
  <div class="participants">
    ...
    <div class="participant" onclick="var c = $(this).down('input'); c.checked = !c.checked;">
      <img class="icon"
        src="<%=participantMgr.getPhotoUrl(nComponentParameter, participant.userId,
								128, 128)%>">
      <div class="txt"><%=participantMgr.getUser(participant.userId)%></div>
  ...
  <%
  	...
  	final String params = WorkitemBean.workitemId + "=" + workitem.getId() + "&"
  			+ WorkitemCompleteUtils.BEAN_ID + "=" + nComponentParameter.hashId();
  %>
  <div class="b">
