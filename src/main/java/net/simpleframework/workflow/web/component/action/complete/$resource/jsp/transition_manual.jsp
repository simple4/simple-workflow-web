...
<%
	final ComponentParameter nComponentParameter = WorkitemCompleteUtils.get(request, response);
...
<div class="simple_window_tcb transition_manual">
  ...
  <div class="c">
    <%
    	for (TransitionNode transition : WorkitemCompleteUtils
    			.getTransitions(nComponentParameter, workitem)) {
    %>
    ...
    <%
    	...
    	final String params = WorkitemBean.workitemId + "="
    			+ workitem.getId() + "&" + WorkitemCompleteUtils.BEAN_ID
    			+ "=" + nComponentParameter.hashId();
    %>
    <div class="msg"></div>
  </div>
  <div class="b">
