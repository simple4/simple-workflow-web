...
public class BXTest extends MyWorklistForm {
	...
	@Override
	protected void onLoad(final PageParameter pParameter, final Map<String, Object> dataBinding,
		...
		//
		dataBinding.put("wf_m", WorkflowContextFactory.get().getProcessMgr()
				.getVariable(process, "m"));
	}
}
